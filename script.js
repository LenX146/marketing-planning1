(function() {
    ...
    function renderTasksForDay() {
        ...
        // и чтобы избежать проблем с пересозданием обработчиков
    ...
    // Если Firebase уже загружен, но initApp не вызван из PIN-кода,
    // мы можем вызвать его автоматически (но лучше через PIN)
    console.log('⏳ Ожидание ввода PIN-кода...');
