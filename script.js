        ...
        collections = [
            { 
                ...
                ideas: [
                    ...
                    { id: generateIdeaId(), text: 'Вязаный свитер с высоким воротом' },
                ]
            },
            { 
                id: generateCollectionId(), 
        ...
        marketing = [
            {
                ...
                description: 'Привлечь 10 микро-инфлюенсеров для создания UGC-контента. Каждый получает бесплатный набор продукции в обмен на 3 поста в Instagram.',
                category: 'social',
                priority: 'high',
                status: 'active',
                date: getTodayString()
...
// ============================================
//   ВЫХОД ИЗ СИСТЕМЫ (дополнительно)
// ============================================
// Функция для очистки данных при выходе
function logoutUser() {
    // PIN-код сбрасывается в index.html через обработчик
